...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
	...
	private List<Recipe> getRecipes() {
		...
		guaca.getIngredients().add(new Ingredient("ripe avocados", new BigDecimal(2), eachUom, guaca));
		guaca.getIngredients().add(new Ingredient("Kosher salt", new BigDecimal(".5"), teaspoonUom, guaca));
		guaca.getIngredients()
				.add(new Ingredient("fresh lime juice or lemon juice", new BigDecimal(2), tablespoonUom, guaca));
		guaca.getIngredients().add(new Ingredient("minced red onion or thinly sliced green onion", new BigDecimal(2),
				tablespoonUom, guaca));
		guaca.getIngredients().add(
				new Ingredient("serrano chiles, stems and seeds removed, minced", new BigDecimal(2), eachUom, guaca));
		guaca.getIngredients().add(new Ingredient("Cilantro", new BigDecimal(2), tablespoonUom, guaca));
		guaca.getIngredients().add(new Ingredient("freshly grated black pepper", new BigDecimal(2), dashUom, guaca));
		guaca.getIngredients().add(
				new Ingredient("ripe tomato, seeds and pulp removed, chopped", new BigDecimal(".5"), eachUom, guaca));
